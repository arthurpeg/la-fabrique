...
- [[phases/phase-08-codeur-de-signal|Phase 08 — Le codeur de signal]] — **pas ouverte, mais son juge est écrit** : `D23` et `scripts/score_signal.py`, six conditions à tolérance zéro, aucun IC dépensé
