...
| **Décision la plus récente** | `decisions/DECISION-28-aucune-ligne-hors-protocole.md` — une mesure faite en calibration (`hypothesis_ref` nul) échappait au décompte **et** à la porte 09 : |
| **Tests au registre** | 169 |
| **Idées abandonnées recensées** | 59 |
| **Entrées au journal** | 77 |
